...
export default function Experience() {
  ...
  useGSAP(
    () => {
      // Linha cresce de cima para baixo
      gsap.fromTo(
        lineRef.current,
        { scaleY: 0 },
        {
      ...
      // Cada item aparece conforme a linha chega nele
  ...
  return (
    <section
      id="experience"
      ref={sectionRef}
      className="section relative flex flex-col items-center justify-center overflow-y-auto py-24 transition-colors duration-300"
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-3xl px-6 md:px-14">
        {/* Header */}
        <div className="mb-20">
          <div className="exp-header-line mb-4 h-px w-16" style={{ backgroundColor: "var(--accent)" }} />
          <h2
        ...
        <div className="relative">
          ...
          >
            <div
              ...
              style={{ backgroundColor: "var(--accent)", transformOrigin: "top center" }}
            />
          </div>
          ...
          <div className="flex flex-col gap-16 pl-8 md:pl-0">
            {t.items.map((item: any, i: number) => (
              <div
                key={i}
                className={`exp-item relative flex flex-col md:flex-row md:gap-12 ${
                  i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                }`}
              >
                {/* Dot */}
                <div
                  className="exp-dot absolute -left-[2.15rem] top-1 h-4 w-4 rounded-full border-2 md:-left-2 md:left-[calc(50%-0.5rem)]"
                  style={{
